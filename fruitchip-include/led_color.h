...
#define RGB_ERR              PICO_COLORED_STATUS_LED_COLOR_FROM_RGB(0x10, 0x00, 0x00) // red
#define RGB_OK_READ_ACTIVITY PICO_COLORED_STATUS_LED_COLOR_FROM_RGB(0x00, 0x00, 0x10) // blue
