...
#define BOOT_ROM_DATA_OUT_NULL_DMA_CHAN 2
...
inline static void boot_rom_data_out_init()
{
    ...
    channel_config_set_chain_to(&dma_tx_data_conf, BOOT_ROM_DATA_OUT_NULL_DMA_CHAN);
...
inline static void boot_rom_data_out_start_data_with_status_code(uint32_t status_code, const volatile void *read_addr, uint32_t encoded_transfer_count)
{
    pio_set_sm_mask_enabled(pio0, (1 << BOOT_ROM_READ_SNIFFER_SM) | (1 << BOOT_ROM_WRITE_SNIFFER_SM), false);
...
inline static void boot_rom_data_out_start_data_without_status_code(const volatile void *read_addr, uint32_t encoded_transfer_count)
{
    pio_set_sm_mask_enabled(pio0, (1 << BOOT_ROM_READ_SNIFFER_SM) | (1 << BOOT_ROM_WRITE_SNIFFER_SM), false);
